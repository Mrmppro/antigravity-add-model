export declare const AUTO_SWITCH_CONFIG_VERSION: 3;
/**
...
export declare function createUnverifiedCapabilities(): VerifiedCapabilities;
/**
...
export type DecisionReason = 'auto-disabled' | 'invalid-policy' | 'no-eligible-route' | 'protected-request' | 'mode-chain' | 'cost-optimized' | 'local-preferred' | 'route-disabled' | 'route-unhealthy' | 'route-unreachable' | 'tools-unverified' | 'images-unverified' | 'verification-stale' | 'context-limit' | 'classifier-result';
...
export declare const DEFAULT_CLASSIFIER_SETTINGS: ClassifierSettings;
export declare const DEFAULT_REVERIFY_DAYS = 30;
export declare function createDefaultAutoSwitchPolicy(): AutoSwitchPolicy;
